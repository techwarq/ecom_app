...
const BASE_PRICE = 5000 // Replace with your base price
...
const CheckOut = () => {
  ...
  const handleCheckout = () => {
    const checkoutUrl = '/configure/checkout'
  ...
  return (
    <>
      ...
      <div className='mt-20 bg-white flex flex-col items-center md:grid text-sm sm:grid-cols-12 sm:grid-rows-1 sm:gap-x-6 md:gap-x-8 lg:gap-x-12'>
